...
namespace LanguageSheet
{
    ...
    { 
        ...
        static string spreadSheetID = "1QUrxUIeY5S-CntUR_NvlBdq5W8dw-Idx8zl6zSAIULQ"; // it is file id
...
#region fuctions
        ...
        public static void Load(bool forceReload = false)
        {
            ...
            string text = reader.ReadData("LanguageSheet"); 
            if (text != null)
            {
